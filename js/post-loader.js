...
(function () {
  ...
  function loadGiscus() {
    ...
    script.setAttribute('data-repo-id', 'R_kgDOQec18Q'); // TODO: Replace with actual repo ID
    script.setAttribute('data-category', 'General');
    script.setAttribute('data-category-id', 'DIC_kwDOQec18c4CzIyg'); // TODO: Replace with actual category ID
